...
import { ChevronRight, Plus, Trophy, CalendarClock } from "lucide-react";
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className={has ? "text-[11px] text-pitch-400" : "text-[11px] text-warning"}>
                      {has ? "Predicho ✓" : "Sin predecir"}
                    </div>
                  </div>
                </div>
              );
